# Generated by Django 2.1.2 on 2019-02-06 16:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('foto', models.ImageField(default='default.jpg', upload_to=lppm.models.upload_poto)),
            ],
        ),
        migrations.CreateModel(
            name='Fakultas',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to=lppm.models.upload_pengabdian)),
                ('status', models.BooleanField(default=False)),
                ('tahun', models.CharField(max_length=5)),
                ('judul', models.CharField(max_length=120)),
                ('created', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddField(
            model_name='anggotapengabdian',
            name='pengabdian',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lppm.Pengabdian'),
        ),
        migrations.AddField(
